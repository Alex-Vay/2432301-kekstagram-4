...
const getRandomComment = () => ({
  ...
  message: Array.from(new Array(getRandomInteger(1, MAX_MESSAGE_LENGTH)), () => getRandomArrayElement(MESSAGE_TEXT)).join(' '),
...
const createPicturePost = () => ({
  ...
  comments: Array.from(new Array(getRandomInteger(MIN_COMMENTS, MAX_COMMENTS)), () => getRandomComment()),
});
